...
object ProductRepository {
    ...
    val produkUtama = mutableListOf(
        Product("Kamera Analog A", 1200000, "android.resource://com.example.miniprojectv2/drawable/kamera_a", 10, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed faucibus lorem tortor, sit amet sodales nisl sagittis auctor. Suspendisse pretium facilisis tincidunt. Phasellus non pretium nisi. Nunc lacus nisi, eleifend."),
        Product("Kamera Analog B", 900000, "android.resource://com.example.miniprojectv2/drawable/kamera_a", 10, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed faucibus lorem tortor, sit amet sodales nisl sagittis auctor. Suspendisse pretium facilisis tincidunt. Phasellus non pretium nisi. Nunc lacus nisi, eleifend."),
        Product("Kamera Analog C", 750000, "android.resource://com.example.miniprojectv2/drawable/kamera_a", 10, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed faucibus lorem tortor, sit amet sodales nisl sagittis auctor. Suspendisse pretium facilisis tincidunt. Phasellus non pretium nisi. Nunc lacus nisi, eleifend.")
    )
